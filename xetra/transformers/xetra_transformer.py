...
class XetraETL():
    ...
    def __init__(self, s3_bucket_src: S3BucketConnector,
        ...
        self.extract_date = None        #TODO: check if this is needed
        self.extract_date_list = None   #TODO: check if this is needed
        self.meta_update_list = None    #TODO: check if this is needed
